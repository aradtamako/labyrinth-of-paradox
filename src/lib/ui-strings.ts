...
const ja = {
  ...
  meta: {
    ...
    description:
      'ダンジョン&ファイター「逆説の迷宮」の攻略データベース。1〜33区域のシードマップ、名声上昇値、主要報酬、調査券・討伐券・傭兵団の仕様をまとめています。',
  },
  ...
  overview: {
    ...
    sourceGuideLabel: 'DCインサイド 던파IP マイナーギャラリー — 미궁 1~33층 모음',
...
const en: UiText = {
  ...
  meta: {
    ...
    description:
      'A strategy database for the Dungeon & Fighter dungeon "Labyrinth of Paradox": seed maps for areas 1–33, fame gains, key rewards, and the rules behind survey tickets, subjugation tickets and the mercenary group.',
  },
  ...
  overview: {
    ...
    sourceGuideLabel: 'DCInside 던파IP minor gallery — 미궁 1~33층 모음',
